...
struct thermal_sensor_hw_ops {
	int (*init)(struct thermal_sensor_device *tdev, int id);
	void (*exit)(struct thermal_sensor_device *tdev, int id);
	void (*reset)(struct thermal_sensor_device *tdev, int id);
	int (*get_temp)(struct thermal_sensor_device *tdev, int id, int *temp);
};
