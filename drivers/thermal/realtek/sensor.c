...
static int thermal_sensor_get_trend(struct thermal_zone_device *tz,
				    ...
				    enum thermal_trend *trend)
{
	...
	dev_dbg(tdev->dev, "trip type=%d, delta=%d, trend=%d\n", trip->type,
		delta, *trend);
	return 0;
}
