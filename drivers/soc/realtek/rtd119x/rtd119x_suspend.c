...
int __init rtk_suspend_init(void)
{
    ...
    if (p_suspend_nd && of_device_is_available(p_suspend_nd)) {
...

        {
            ...
            int cnt_wakeup_gpio_list    = of_count_phandle_with_args(p_suspend_nd, "wakeup-gpio-list", "#gpio-cells");
...

        {
            ...
            int cnt_output_change_gpio_list     = of_count_phandle_with_args(p_suspend_nd, "gpio-output-change-list", "#gpio-cells");
...
static int __init suspend_sysfs_init(void)
{
    ...
    rtk_pm_class = class_create("rtk_pm");
