...
static void rtk_efuse_remove(struct platform_device *pdev)
{
...
static __exit void rtk_efuse_exit(void)
{
	platform_driver_unregister(&rtk_efuse_drv);
	sysfs_destroy();
}
module_exit(rtk_efuse_exit);
